...
exports.parseDynamicWhereObject = void 0;
const like_service_1 = require("./like.service");
const quotes_service_1 = require("./quotes.service");
const parseDynamicWhereObject = (where) => {
    var _a;
    const parsed = [];
    if (!where) {
        return parsed;
    ...
    (_a = Object.entries(where)) === null || _a === void 0 ? void 0 : _a.forEach(([key, value]) => {
        ...
        const tempProperty = prepareDynamicWhereValue(propertyName, value, modifiers);
        parsed.push(tempProperty);
    });
    return parsed;
};
exports.parseDynamicWhereObject = parseDynamicWhereObject;
const prepareAndOrValues = (property, values, modifiers) => {
    const properties = [];
    values.forEach((value) => {
        const [_, ...otherModifiers] = modifiers;
        const tempProperty = prepareDynamicWhereValue(property, value, otherModifiers);
...
const prepareDynamicWhereValue = (property, value, modifiers) => {
    ...
    const like = (0, like_service_1.prepareLike)();
    let ifNot = '';
...
//# sourceMappingURL=dynamic.where.service.js.map