...
[![Version](https://img.shields.io/badge/version-v0.13.0-blue)](https://github.com/fwmakc/api-server-toolkit/releases)
...
```bash
npm install github:fwmakc/api-server-toolkit#v0.13.0
```
